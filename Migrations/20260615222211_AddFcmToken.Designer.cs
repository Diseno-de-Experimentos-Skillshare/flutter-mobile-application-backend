...
namespace SkillShareBackend.Migrations
{
    ...
    [Migration("20260615222211_AddFcmToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillShareBackend.Models.DocumentFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("document_favorites", (string)null);
                });
            ...
            modelBuilder.Entity("SkillShareBackend.Models.User", b =>
                {
                    ...
                    b.Property<bool>("SessionRemindersEnabled")
                        ...
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("session_reminders_enabled");
            ...
            modelBuilder.Entity("SkillShareBackend.Models.DocumentFavorite", b =>
                {
                    b.HasOne("SkillShareBackend.Models.GroupDocument", "Document")
                        .WithMany()
